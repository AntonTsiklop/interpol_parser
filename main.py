...
yellow_notices.json_write(yellow_notices_list, 'yellow_notices')

yellow_notices_details = NoticeDetailsParser(yellow_notices_link)
yellow_notices_details.json_write(yellow_notices_details.parse_details(yellow_notices_list), 'yellow_notices_details')
