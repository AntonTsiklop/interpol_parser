...
yellow_notices = NoticesParser(red_notices_link)
yellow_notices_list = red_notices.parse_notices()
yellow_notices.json_write(red_notices_list, 'red_notices')

yellow_notices_details = NoticeDetailsParser(red_notices_link)
yellow_notices_details.json_write(red_notices_details.parse_details(red_notices_list), 'red_notices_details')

yellow_notices_thumbnails = NoticesThumbnailsParser(red_notices_link)
yellow_notices_thumbnails.parse_thumbnails('images_yellow', red_notices_list)
